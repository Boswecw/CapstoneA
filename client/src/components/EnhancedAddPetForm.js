              ...
              <div className="local-images">
                ...
                <details className="path-help">
                  ...
                  <div className="help-content">
                    <ol>
                      <li>Create folder: <code>public/images/pets/</code></li>
                      <li>Copy your image files there</li>
                      <li>Use filename only (e.g., "mydog.jpg")</li>
                      <li>Refresh this page and the file will appear in the dropdown</li>
                    </ol>
            ...
            {imagePreview && (
              <div className="image-preview">
                ...
                <div className="preview-path">
                  <small>Path: <code>{imagePreview}</code></small>
                </div>
              </div>
            )}
          </div>
