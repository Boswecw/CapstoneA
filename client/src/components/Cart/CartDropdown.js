    ...
    >
      ...
      <div style={{ maxHeight: '250px', overflowY: 'auto', padding: '0.5rem' }}>
        {items.length === 0 ? (
          ...
          items.map(item => (
            <Card key={item.id} className="mb-2" style={{ border: '1px solid #f0f0f0' }}>
              <Card.Body className="p-2">
                <Row className="align-items-center">
                  ...
                  <Col xs={6}>
                    <h6 className="mb-1" style={{ fontSize: '0.9rem' }}>{item.name}</h6>
                  ...
                  <Col xs={3} className="text-end">
                    <div className="d-flex align-items-center justify-content-end mb-1">
                      ...
                      <span className="mx-2" style={{ fontSize: '0.9rem' }}>{item.quantity}</span>
                      <Button 
                        variant="outline-secondary" 
                        size="sm"
                        onClick={() => updateQuantity(item.id, item.quantity + 1)}
