          ...
          <Row className="justify-content-center align-items-center">
            <Col xs={12} md={10}>
              ...
              <p className="hero-subtitle">
                <i className="fas fa-heart me-2"></i>Find Your Perfect Canine
                Companion
              </p>
        ...
        <Row className="mb-4">
          <Col>
            ...
            <p className="text-center text-muted">
              All our dogs come from ethical sources and are ready for their
              forever homes.
            </p>
          </Col>
        </Row>
          ...
          <>
            <div className="mb-3">
              <span className="text-muted">
                {dogs.length} dog{dogs.length !== 1 ? "s" : ""} available for
                adoption
              </span>
            </div>
